            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        ...
                        <!-- end page title -->
                        <div class="row" <?php echo $enrolId!=0 ? 'd-none' : '' ?>>
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="enquiry_id" class="form-control" name='enquiry_id' value="<?php echo $queryRes['st_enquiry_id']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        ?>                                                            
                                                            <option value="<?php echo $coursesRes['st_enrol_course']; ?>" <?php echo $coursesRes['st_enrol_course']==$queryRes['st_course'] ? 'selected' : ''; ?>><?php echo $coursesRes['course_name']; ?></option>
                                                            <?php } ?>
                                                        </select>    
                                                        <div class="error-feedback">
        ...
        <script>
            $(document).on('click','#enrolment_check',function(){
                ...
                if(qualifications==''|| given_name=='' ||name_main=='' ||source==''||middle_name==''||venue==''||  ( contactName=='' || contactName.length!=10 ) ||emailAddress==''|| (emailAddress!='' && !emailAddress.match(emailregexp)==true ) ){
                    ...
                    if(emailAddress!='' && !emailAddress.match(emailregexp)==true ){
