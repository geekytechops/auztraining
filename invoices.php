    ...
    <body data-topbar="colored">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <button class="form-control btn btn-primary" type="button" style="width:20%;" id="invoice_submit">Submit</button>
                                    </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            $(document).on('click','#invoice_submit',function(){
                ...
                if(payment_date==''|| student_name=='' ||course_name=='' ||course_fee==''||amount_paid==''||amount_due==''){
                    if(payment_date==''){
                    ...
                    details={formName:'invoice_submit',payment_date:payment_date,amount_due:amount_due,amount_paid:amount_paid,course_fee:course_fee,course_name:course_name,student_name:student_name};
                    $.ajax({
                        type:'post',
