...
$enrolment_pages    = array('enrolment', 'enrolment_online');
                    ...
                    <ul>
                        ...
                        <li>
                            <ul>
                                ...
                                <?php if(@$_SESSION['user_type']==1 || @$_SESSION['user_type']==2){ ?>
                                <li>
                                    <a href="invoices1.php" class="<?php echo $current_page === 'invoices1' ? 'active' : ''; ?>"><i class="ti ti-file-invoice"></i><span>Invoices</span></a>
                                </li>
                                <?php } ?>
